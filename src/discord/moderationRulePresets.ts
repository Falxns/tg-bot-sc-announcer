...
export const MODERATION_RULE_PRESETS: readonly ModerationRulePreset[] = [
  ...
  { id: "rule_religion", point: "3.2", choiceLabel: "п. 3.2 — Религия", shortTitle: "Религия", body: "Провокационное обсуждение религии." },
  { id: "rule_politics", point: "3.3", choiceLabel: "п. 3.3 — Политика", shortTitle: "Политика", body: "Политика и политический контент." },
  { id: "rule_toxicity_disinfo", point: "3.4", choiceLabel: "п. 3.4 — Токсичность / дезинформация", shortTitle: "Токсичность / дезинформация", body: "Токсичность, клевета, дезинформация об игре." },
  { id: "rule_baiting", point: "3.5", choiceLabel: "п. 3.5 — Провокация", shortTitle: "Провокация", body: "Провокация на нарушение правил." },
  { id: "rule_defamation", point: "3.6", choiceLabel: "п. 3.6 — Клевета / Ложь", shortTitle: "Клевета / Ложь", body: "Клевета и ложь об участниках, администрации или ресурсах." },
  { id: "rule_staff_criticism", point: "3.7", choiceLabel: "п. 3.7 — Осуждение модерации", shortTitle: "Осуждение модерации", body: "Осуждение администрации и/или модерации без доказательств." },
